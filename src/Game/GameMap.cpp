...
void GameMap::PlaceRandomObjects(int count)
{
	...
	while (placed < count && attemps < maxAttemps)
	{
		...
		switch (objChoice)
		{
		case 0:  objectType = ObjectType::Rock; break;
		case 1:  objectType = ObjectType::Log; break;
		case 2:  objectType = ObjectType::Bush1; break;
		case 3:  objectType = ObjectType::Bush2; break;
		case 4:  objectType = ObjectType::Grass1; break;
		case 5:  objectType = ObjectType::Grass2; break;
		case 6:  objectType = ObjectType::Flower1; break;
		case 7:  objectType = ObjectType::Flower2; break;
		case 8:  objectType = ObjectType::Flower3; break;
		case 9:  objectType = ObjectType::Flower4; break;
		case 10: objectType = ObjectType::Berries; break;
		case 11: objectType = ObjectType::Fruit; break;
		case 12: objectType = ObjectType::PurpleShrooms; break;
		case 13: objectType = ObjectType::RedShrooms; break;
		default:
